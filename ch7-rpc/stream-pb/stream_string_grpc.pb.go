...
const (
	...
	StringService_LotsOfServerStream_FullMethodName          = "/pb.StringService/LotsOfServerStream"
	StringService_LotsOfClientStream_FullMethodName          = "/pb.StringService/LotsOfClientStream"
	StringService_LotsOfServerAndClientStream_FullMethodName = "/pb.StringService/LotsOfServerAndClientStream"
)
...
func (c *stringServiceClient) LotsOfServerStream(ctx context.Context, in *StringRequest, opts ...grpc.CallOption) (StringService_LotsOfServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StringService_ServiceDesc.Streams[0], StringService_LotsOfServerStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *stringServiceClient) LotsOfClientStream(ctx context.Context, opts ...grpc.CallOption) (StringService_LotsOfClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StringService_ServiceDesc.Streams[1], StringService_LotsOfClientStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *stringServiceClient) LotsOfServerAndClientStream(ctx context.Context, opts ...grpc.CallOption) (StringService_LotsOfServerAndClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StringService_ServiceDesc.Streams[2], StringService_LotsOfServerAndClientStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
// All implementations should embed UnimplementedStringServiceServer
...
// UnimplementedStringServiceServer should be embedded to have forward compatible implementations.
...
var StringService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "stream-pb/stream_string.proto",
}
